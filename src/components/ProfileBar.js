...
const ProfileBar = ({ showProfile, setShowProfile }) => {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      let storageResult = await firebase
        .storage()
        .ref(`profile/${user.uid}/${file.name}`)
        .put(file);
        ...
        <>
          <Wrapper>
            ...
            >
              {showProfileEdit ? (
                <IconWrapper>
                  <FiEdit2 onClick={() => setShowModal(true)} />
                </IconWrapper>
              ) : (
                ""
              )}
              <ProfilePic
                src={
                  user.photoURL ||
                  "https://firebasestorage.googleapis.com/v0/b/chat-294407.appspot.com/o/events%2Fprofile.jpg?alt=media&token=84fe27e6-82e7-4599-baca-d1cd92cb9a57"
                }
            ...
            <UserInfoWrapper>
              ...
              <div
                onDoubleClick={() => setShowDisplayNameEdit(false)}
                onMouseLeave={() => setShowDisplayNameEdit(true)}
              >
              ...
              <div style={{ position: "relative" }}>
                <Heading>Bio</Heading>
                <p style={{ wordBreak: "break-all" }}>Hi, I am User ...</p>
              </div>
              <hr />
              <div
                onDoubleClick={() => setShowTypeEdit(false)}
                onMouseLeave={() => setShowTypeEdit(true)}
              >
              ...
              <Button style={{ marginBottom: "3em" }} onClick={handleSignOut}>
                Sign Out
              </Button>
            </UserInfoWrapper>
            {showModal ? (
